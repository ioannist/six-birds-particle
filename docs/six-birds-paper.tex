...
P2 carves feasibility/representability,
P1 rewrites dynamics when closure fails to descend,
and P3 diagnoses \mbox{noncommuting} reduction routes (route mismatch), which is \emph{not} a directionality certificate.
Emergence means the appearance of stable fixed points within a theory, while open-endedness means strict theory extension rather than iteration of a fixed closure.
...
\begin{itemize}
  ...
  \item societies and civilizations, and von Neumann-type machines,
...
Repository: \url{https://github.com/ioannist/six-birds-theory}.
